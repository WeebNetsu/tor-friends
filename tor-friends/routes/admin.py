...
admin_page = Blueprint(
    "admin", __name__, static_folder=f"{get_root()}static", template_folder=f"{get_root()}templates/admin")
        ...
        if request.method == "POST":  # if they logged in
            ...
            try:
                ...
                new_user = Users(username=username,
                                 password=encrypt_string(password), mod_=is_mod, date_accessed=datetime.today())
